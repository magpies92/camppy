...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="member/join/ctest.css" />
...
function validateForm() {
  ...
  <body>
  <form onsubmit="return validateForm(event)" action="ctestpro.mem" method="post">
   ...
   <input type="text" id="memberSignId" class="member-sign__2" name="member_id" placeholder="아이디">
          </div>
   ...
   <input type="text" id="memberSingNick" class="member-sign__2" name="nickname" placeholder="닉네임">
          </div>
   ...
   <input type="tel" id="memberSingPhone" class="member-sign__2" name="phonenum" placeholder="휴대전화">
