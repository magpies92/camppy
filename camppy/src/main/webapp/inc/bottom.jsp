...
.section-footer__footer-info {
  ...
  border-style: solid;
  border-color: #4a4a4c;
  border-width: 0px 0px 0.98px 0px;
  padding: 0px 9.79px 4.9px 9.79px;
  display: flex;
  flex-direction: row;
  gap: 0px;
  align-items: flex-start;
...
.section-footer__footer-list {
  padding: 14.69px 160.58px 14.69px 160.58px;
  display: flex;
  flex-direction: row;
  gap: 0px;
  align-items: flex-start;
  ...
  position: absolute;
  right: 622.26px;
  left: 161.07293701171875px;
  top: 13.71px;
}
.section-footer__footer-list-1 {
  padding: 0px 16.29px 0.98px 17.62px;
  display: flex;
  flex-direction: row;
  gap: 0px;
  align-items: flex-start;
...
.section-footer__info-site-1 {
  background: #393a3b;
  padding: 0.98px 18.6px 0.98px 18.6px;
  display: flex;
  flex-direction: row;
  gap: 9.79px;
  align-items: flex-start;
