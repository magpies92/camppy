	...
	<div class="section-footer">
		...
		<div class="section-footer__footer-copyright">
			<div class="section-footer__footer-info2">
				<div class="section-footer___109-7">부산광역시 부산진구 부전동 동천로 109
					삼한골든게이트 아이티윌 부산교육센터 7층</div>
				<div class="section-footer__email-camppy-itwillbs-co-kr">
					<span><span
						class="section-footer-email-camppy-itwillbs-co-kr-span">EMAIL
							: camppy</span><span
						class="section-footer-email-camppy-itwillbs-co-kr-span2">@itwillbs.co.kr</span></span>
				</div>
				<div
				...
				<div class="section-footer___051-803-0909">온라인교육 고객센터 :
					051-803-0909</div>
