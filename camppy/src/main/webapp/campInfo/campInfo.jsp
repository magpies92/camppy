...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="./campInfo.css" />
...
<!-- 캠핑장 중간 사진 -->
 <div class="campCenterImg">
   <img class="campCenterImg1"
    src="campCenterImg1.png"/>
  <img class="campCenterImg2"
   src="campCenterImg2.png"/>
  <img class="campCenterImg3"
   src="campCenterImg3.png"/>
 </div>
...
<!-- 캠핑장 시설 정보 -->
 <div class="campInfoFacilities">
   <img class="facilitiesIcon" src="_1.png"/>
   <div class="infoFacilities">캠핑장 시설 정보</div>
   <!-- 아이콘 -->
   <div class="facilitiesImgBox">
     <img class="facilitiesImg" src="_2023-08-18-6-16-1.png"/> 
   </div>
   <!-- 추신 -->
   <div class="infoSpan">
...
<!-- 캠핑장 추가 사진 전체 -->
 <div class="campPictureBox">
 <!--캠핑장 추가 사진 구역 제목-->
   <img class="campPictureIcon" src="_1.png" />
   <div class="campPictureTitle">사천비토솔섬오토캠핑장</div>
 <!--캠핑장 추가 사진-->
