...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="./mypageReview.css" />
 ...
 <style>
  ...
  <body>
    <jsp:include page="./mypageInc/mypageInc.jsp"></jsp:include>
        ...
        <input type= "checkbox" class= "selectCheck" id="cboxAll"
        ><b>전체선택</b>
        </label>       
          </div>
          <div class="mypageReview1">
           ...
           <input type="checkbox" class = "reviewCheckbox1"
           name="cbox"/>
          </div>
          <div class="mypageReview2">
            ...
            <input type="checkbox" class = "reviewCheckbox2"
             name="cbox"/>
         </div>
